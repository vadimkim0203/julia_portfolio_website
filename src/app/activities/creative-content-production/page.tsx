...
const CONTENT_CREATION_TFIT_VIDEOS = [
  {
...
export default function CreativeContentProductionActivity() {
  const { t } = useLanguage();
      ...
      <motion.div variants={VARIANTS_ITEM} transition={TRANSITION}>
        ...
        <div className="space-y-4">
          <h1 className="text-3xl font-bold md:text-4xl">
            {t('activity.creative-content-production.title')}
          </h1>
          <p className="text-lg text-zinc-600 dark:text-zinc-400">
            {t('activity.creative-content-production.description')}
          </p>
        </div>
      </motion.div>
